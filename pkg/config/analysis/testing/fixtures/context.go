...
func (ctx *Context) Find(config.GroupVersionKind, resource.FullName) *resource.Instance {
	// Exists implements analysis.Context	return nil
}

func (ctx *Context) Exists(config.GroupVersionKind, resource.FullName) bool {
	// ForEach implements analysis.Context	return false
}
