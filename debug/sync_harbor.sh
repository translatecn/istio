...
t registry.cn-hangzhou.aliyuncs.com/acejilam/microservices-demo-adservice:v0.9.0
t registry.cn-hangzhou.aliyuncs.com/acejilam/microservices-demo-cartservice:v0.9.0
t registry.cn-hangzhou.aliyuncs.com/acejilam/microservices-demo-checkoutservice:v0.9.0
t registry.cn-hangzhou.aliyuncs.com/acejilam/microservices-demo-currencyservice:v0.9.0
t registry.cn-hangzhou.aliyuncs.com/acejilam/microservices-demo-emailservice:v0.9.0
t registry.cn-hangzhou.aliyuncs.com/acejilam/microservices-demo-frontend:v0.9.0
t registry.cn-hangzhou.aliyuncs.com/acejilam/busybox:latest
t registry.cn-hangzhou.aliyuncs.com/acejilam/microservices-demo-loadgenerator:v0.9.0
t registry.cn-hangzhou.aliyuncs.com/acejilam/microservices-demo-paymentservice:v0.9.0
t registry.cn-hangzhou.aliyuncs.com/acejilam/microservices-demo-productcatalogservice:v0.9.0
t registry.cn-hangzhou.aliyuncs.com/acejilam/microservices-demo-recommendationservice:v0.9.0
t registry.cn-hangzhou.aliyuncs.com/acejilam/redis:alpine
t registry.cn-hangzhou.aliyuncs.com/acejilam/microservices-demo-shippingservice:v0.9.0
