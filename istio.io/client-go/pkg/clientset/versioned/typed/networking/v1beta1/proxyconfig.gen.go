...
type ProxyConfigInterface interface {
	...
	Apply(ctx context.Context, proxyConfig *networkingv1beta1.ProxyConfigApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.ProxyConfig, err error)
	ApplyStatus(ctx context.Context, proxyConfig *networkingv1beta1.ProxyConfigApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.ProxyConfig, err error)
...
func (c *proxyConfigs) Apply(ctx context.Context, proxyConfig *networkingv1beta1.ProxyConfigApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.ProxyConfig, err error) {
	if proxyConfig == nil {
