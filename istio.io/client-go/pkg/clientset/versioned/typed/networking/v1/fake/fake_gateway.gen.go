...
func (c *FakeGateways) Apply(ctx context.Context, gateway *networkingv1.GatewayApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Gateway, err error) {
	if gateway == nil {
...
func (c *FakeGateways) ApplyStatus(ctx context.Context, gateway *networkingv1.GatewayApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Gateway, err error) {
	if gateway == nil {
		return nil, fmt.Errorf("gateway provided to Apply must not be nil")
	}
	data, err := json.Marshal(gateway)
