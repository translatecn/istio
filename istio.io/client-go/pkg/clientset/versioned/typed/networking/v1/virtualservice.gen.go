...
type VirtualServiceInterface interface {
	...
	Apply(ctx context.Context, virtualService *networkingv1.VirtualServiceApplyConfiguration, opts metav1.ApplyOptions) (result *v1.VirtualService, err error)
	ApplyStatus(ctx context.Context, virtualService *networkingv1.VirtualServiceApplyConfiguration, opts metav1.ApplyOptions) (result *v1.VirtualService, err error)
...
func newVirtualServices(c *NetworkingV1Client, namespace string) *virtualServices {
...
func (c *virtualServices) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.VirtualService, err error) {
...
func (c *virtualServices) List(ctx context.Context, opts metav1.ListOptions) (result *v1.VirtualServiceList, err error) {
...
func (c *virtualServices) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *virtualServices) Create(ctx context.Context, virtualService *v1.VirtualService, opts metav1.CreateOptions) (result *v1.VirtualService, err error) {
	result = &v1.VirtualService{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("virtualservices").
...
func (c *virtualServices) Update(ctx context.Context, virtualService *v1.VirtualService, opts metav1.UpdateOptions) (result *v1.VirtualService, err error) {
	result = &v1.VirtualService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("virtualservices").
...
func (c *virtualServices) UpdateStatus(ctx context.Context, virtualService *v1.VirtualService, opts metav1.UpdateOptions) (result *v1.VirtualService, err error) {
	result = &v1.VirtualService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("virtualservices").
...
func (c *virtualServices) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *virtualServices) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *virtualServices) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.VirtualService, err error) {
	result = &v1.VirtualService{}
...
func (c *virtualServices) Apply(ctx context.Context, virtualService *networkingv1.VirtualServiceApplyConfiguration, opts metav1.ApplyOptions) (result *v1.VirtualService, err error) {
...
func (c *virtualServices) ApplyStatus(ctx context.Context, virtualService *networkingv1.VirtualServiceApplyConfiguration, opts metav1.ApplyOptions) (result *v1.VirtualService, err error) {
	if virtualService == nil {
		return nil, fmt.Errorf("virtualService provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
