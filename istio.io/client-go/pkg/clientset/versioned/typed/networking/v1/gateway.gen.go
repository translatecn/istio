...
type GatewayInterface interface {
	...
	Apply(ctx context.Context, gateway *networkingv1.GatewayApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Gateway, err error)
	ApplyStatus(ctx context.Context, gateway *networkingv1.GatewayApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Gateway, err error)
	GatewayExpansion
}
...
func newGateways(c *NetworkingV1Client, namespace string) *gateways {
	return &gateways{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *gateways) Apply(ctx context.Context, gateway *networkingv1.GatewayApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Gateway, err error) {
	if gateway == nil {
...
func (c *gateways) ApplyStatus(ctx context.Context, gateway *networkingv1.GatewayApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Gateway, err error) {
	if gateway == nil {
		return nil, fmt.Errorf("gateway provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
