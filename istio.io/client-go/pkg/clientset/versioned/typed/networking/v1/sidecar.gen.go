...
type SidecarInterface interface {
	...
	UpdateStatus(ctx context.Context, sidecar *v1.Sidecar, opts metav1.UpdateOptions) (*v1.Sidecar, error)
	...
	Apply(ctx context.Context, sidecar *networkingv1.SidecarApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Sidecar, err error)
	ApplyStatus(ctx context.Context, sidecar *networkingv1.SidecarApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Sidecar, err error)
	SidecarExpansion
}
...
func newSidecars(c *NetworkingV1Client, namespace string) *sidecars {
	return &sidecars{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *sidecars) UpdateStatus(ctx context.Context, sidecar *v1.Sidecar, opts metav1.UpdateOptions) (result *v1.Sidecar, err error) {
	result = &v1.Sidecar{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sidecars").
...
func (c *sidecars) Apply(ctx context.Context, sidecar *networkingv1.SidecarApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Sidecar, err error) {
	if sidecar == nil {
...
func (c *sidecars) ApplyStatus(ctx context.Context, sidecar *networkingv1.SidecarApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Sidecar, err error) {
	if sidecar == nil {
		return nil, fmt.Errorf("sidecar provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
