...
// TelemetryV1Client is used to interact with features provided by the telemetry.istio.io group.
type TelemetryV1Client struct {
	restClient rest.Interface
}

func (c *TelemetryV1Client) Telemetries(namespace string) TelemetryInterface {
