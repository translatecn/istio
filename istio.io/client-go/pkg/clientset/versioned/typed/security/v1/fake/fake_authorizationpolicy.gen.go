...
var authorizationpoliciesResource = v1.SchemeGroupVersion.WithResource("authorizationpolicies")

var authorizationpoliciesKind = v1.SchemeGroupVersion.WithKind("AuthorizationPolicy")
...
func (c *FakeAuthorizationPolicies) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.AuthorizationPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(authorizationpoliciesResource, c.ns, name), &v1.AuthorizationPolicy{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1.AuthorizationPolicy), err
}

// List takes label and field selectors, and returns the list of AuthorizationPolicies that match those selectors.
func (c *FakeAuthorizationPolicies) List(ctx context.Context, opts metav1.ListOptions) (result *v1.AuthorizationPolicyList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(authorizationpoliciesResource, authorizationpoliciesKind, c.ns, opts), &v1.AuthorizationPolicyList{})
	...
	list := &v1.AuthorizationPolicyList{ListMeta: obj.(*v1.AuthorizationPolicyList).ListMeta}
	for _, item := range obj.(*v1.AuthorizationPolicyList).Items {
...
func (c *FakeAuthorizationPolicies) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeAuthorizationPolicies) Create(ctx context.Context, authorizationPolicy *v1.AuthorizationPolicy, opts metav1.CreateOptions) (result *v1.AuthorizationPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(authorizationpoliciesResource, c.ns, authorizationPolicy), &v1.AuthorizationPolicy{})
...
func (c *FakeAuthorizationPolicies) Update(ctx context.Context, authorizationPolicy *v1.AuthorizationPolicy, opts metav1.UpdateOptions) (result *v1.AuthorizationPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(authorizationpoliciesResource, c.ns, authorizationPolicy), &v1.AuthorizationPolicy{})
...
func (c *FakeAuthorizationPolicies) UpdateStatus(ctx context.Context, authorizationPolicy *v1.AuthorizationPolicy, opts metav1.UpdateOptions) (*v1.AuthorizationPolicy, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(authorizationpoliciesResource, "status", c.ns, authorizationPolicy), &v1.AuthorizationPolicy{})
...
func (c *FakeAuthorizationPolicies) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(authorizationpoliciesResource, c.ns, name, opts), &v1.AuthorizationPolicy{})
...
func (c *FakeAuthorizationPolicies) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1.AuthorizationPolicyList{})
	return err
}
...
func (c *FakeAuthorizationPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.AuthorizationPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(authorizationpoliciesResource, c.ns, name, pt, data, subresources...), &v1.AuthorizationPolicy{})
...
func (c *FakeAuthorizationPolicies) Apply(ctx context.Context, authorizationPolicy *securityv1.AuthorizationPolicyApplyConfiguration, opts metav1.ApplyOptions) (result *v1.AuthorizationPolicy, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(authorizationpoliciesResource, c.ns, *name, types.ApplyPatchType, data), &v1.AuthorizationPolicy{})
...
func (c *FakeAuthorizationPolicies) ApplyStatus(ctx context.Context, authorizationPolicy *securityv1.AuthorizationPolicyApplyConfiguration, opts metav1.ApplyOptions) (result *v1.AuthorizationPolicy, err error) {
	if authorizationPolicy == nil {
		return nil, fmt.Errorf("authorizationPolicy provided to Apply must not be nil")
	}
	data, err := json.Marshal(authorizationPolicy)
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(authorizationpoliciesResource, c.ns, *name, types.ApplyPatchType, data, "status"), &v1.AuthorizationPolicy{})
