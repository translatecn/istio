...
import (
	metav1alpha1 "istio.io/istio/istio.io/api/meta/v1alpha1"
	v1alpha1 "istio.io/istio/istio.io/api/telemetry/v1alpha1"
	v1 "istio.io/istio/istio.io/client-go/pkg/applyconfiguration/meta/v1"
	metav1 "k8s.io/apimachinery/pkg/apis/meta/v1"
	types "k8s.io/apimachinery/pkg/types"
)

// TelemetryApplyConfiguration represents an declarative configuration of the Telemetry type for use
// with apply.
type TelemetryApplyConfiguration struct {
	v1.TypeMetaApplyConfiguration    `json:",inline"`
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	Spec                             *v1alpha1.Telemetry       `json:"spec,omitempty"`
	Status                           *metav1alpha1.IstioStatus `json:"status,omitempty"`
}

// Telemetry constructs an declarative configuration of the Telemetry type for use with
// apply.
func Telemetry(name, namespace string) *TelemetryApplyConfiguration {
	b := &TelemetryApplyConfiguration{}
	b.WithName(name)
	b.WithNamespace(namespace)
	b.WithKind("Telemetry")
	b.WithAPIVersion("telemetry.istio.io/v1alpha1")
	return b
}
...
func (b *TelemetryApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
